...
public abstract class ExAstrisBlockContainerBase extends BlockContainer implements IHasModel {
    ...
    public ExAstrisBlockContainerBase(String name, CreativeTabs tab, Material material, SoundType sound, int harvestLevel,
