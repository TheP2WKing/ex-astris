...
public class ExAstris {
    ...
    public static final String DEPENDENCIES = "required-after:forge@[14.23.5.2847,);required-after:exnihilocreatio@[1.12.2-0.4.7,);after:chisel@[MC1.12.2-1.0.1,);after:redstonearsenal@[2.6.6,);after:thaumcraft@[6,);after:thaumicaugmentation;";
