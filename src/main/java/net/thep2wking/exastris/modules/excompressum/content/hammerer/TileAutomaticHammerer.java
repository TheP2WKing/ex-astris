...
public class TileAutomaticHammerer extends TileAutomaticHammererBase implements IEnergyReceiver {
	private final EnergyStorageModifiable energyStorage = new EnergyStorageModifiable(
			ExAstrisConfig.MODULE_EX_COMPRESSUM.AUTOMATIC_HAMMERER.ENERGY_STORAGE) {
		@Override
