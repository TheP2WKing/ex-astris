...
import net.thep2wking.exastris.modules.excompressum.content.hammerer.BlockAutomaticHammerer;
...
public class ExAstrisExCompressumBlocks {
	...
	public static final Block AUTOMATIC_HAMMERER = new BlockAutomaticHammerer("automatic_hammerer", ExAstrisTabs.EXASTRIS_TAB, Material.IRON, SoundType.METAL, 0, EnumToolType.PICKAXE, 5.0F, 5.0F, 0.0F);
}