...
public class ContainerAutomaticHammerer extends Container {
	private final TileAutomaticHammererBase tileEntity;

	private float lastProgress;
	private int lastEnergy;
	private boolean lastDisabledByRedstone;

	public ContainerAutomaticHammerer(InventoryPlayer inventoryPlayer, TileAutomaticHammererBase tileEntity) {
