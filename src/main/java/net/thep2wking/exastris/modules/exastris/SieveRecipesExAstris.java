...
public class SieveRecipesExAstris {
	public static void register() {
		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.STRINGS_FROM_INFESTED_LEAVES) {
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.FERN_SEEDS_FROM_DIRT) {
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.PODZOL_SEEDS_FROM_DIRT) {
			ExNihiloRegistryManager.SIEVE_REGISTRY.register("dirt",
					new ItemInfo(ExAstrisItems.SEEDS_PODZOL, 0), 0.05f, BlockSieve.MeshType.STRING.getID());
		}

		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.PRISMARINE_CRYSTALS_FROM_SAND) {
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.VANILLA_DROPS_FROM_HIGHER_MESH_TIERS) {
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.ENDER_PEARLS_FROM_CRUSHED_ENDSTONE) {
			ExNihiloRegistryManager.SIEVE_REGISTRY.register(
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.CHORUS_FRUITS_FROM_CRUSHED_ENDSTONE) {
			ExNihiloRegistryManager.SIEVE_REGISTRY.register(
					new ItemInfo(Item.getItemFromBlock(ModBlocks.endstoneCrushed), 0),
					new ItemInfo(Items.CHORUS_FRUIT, 0), 0.02f, BlockSieve.MeshType.DIAMOND.getID());
		}

		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.CHORUS_SEEDS_FROM_CRUSHED_ENDSTONE) {
			ExNihiloRegistryManager.SIEVE_REGISTRY.register(
					new ItemInfo(Item.getItemFromBlock(ModBlocks.endstoneCrushed), 0),
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.NETHERRACK_PEBBLES_FROM_DIRT) {
			ExNihiloRegistryManager.SIEVE_REGISTRY.register("dirt",
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.ENDSTONE_PEBBLES_FROM_DIRT) {
			ExNihiloRegistryManager.SIEVE_REGISTRY.register("dirt",
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.SIEVE_RECIPES.ICE_SHARDS_FROM_SNOW) {
