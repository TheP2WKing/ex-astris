...
public class CraftingRecipesExAstris {
	public static void register() {
		if (ExAstrisConfig.MODULE_EX_ASTRIS.MISC.HARD_STONE) {
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.MOB_DOLLS.VILLAGER_DOLL) {
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.MOB_DOLLS.EVOKER_DOLL) {
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.MISC.SEEDS_TO_SOIl) {
