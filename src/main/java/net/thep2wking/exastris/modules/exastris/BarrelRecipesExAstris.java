...
public class BarrelRecipesExAstris {
	public static void register() {
		if (ExAstrisConfig.MODULE_EX_ASTRIS.BARREL_RECIPES.SPONGE_FROM_SLIME) {
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.BARREL_RECIPES.WITCHWATER_FROM_STEWS) {
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.BARREL_RECIPES.DARK_OAK_SAPLING_FROM_OAK_SAPLING) {
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.BARREL_RECIPES.TALL_GRASS_AND_FLOWERS_FROM_WITCHWATER) {
			ExNihiloRegistryManager.FLUID_BLOCK_TRANSFORMER_REGISTRY.register(ModFluids.fluidWitchwater,
		...
		if (ExAstrisConfig.MODULE_EX_ASTRIS.BARREL_RECIPES.FROSTY_DIRT_FROM_FROSTWATER) {
