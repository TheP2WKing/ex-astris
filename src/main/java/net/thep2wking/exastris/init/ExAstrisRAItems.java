...
public class ExAstrisRAItems {
    public static final List<Item> ITEMS_RA = new ArrayList<Item>();
        ...
        public static final Item HAMMER_FLUX = new ItemFluxInfusedHammer("hammer_rf", ExAstrisTabs.EXASTRIS_TAB,
                       320000, 4000, 400, 800, 4, 6, 16f);
        public static final Item CROOK_FLUX = new ItemFluxInfusedCrook("crook_rf", ExAstrisTabs.EXASTRIS_TAB, 320000,
                        4000, 200, 400, 2, 4, 6f);
}
